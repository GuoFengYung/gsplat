...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
    ...
    // 2dgs fw
    m.def("rasterize_forward_2d", &rasterize_forward_tensor_2d);
    // 2dgs bp
    m.def("rasterize_backward_2d", &rasterize_backward_tensor_2d);
    // 2dgs project forward
    m.def("project_gaussians_forward_2d", &project_gaussians_forward_tensor_2d);
    // 2dgs project backward
    m.def("project_gaussians_backward_2d", &project_gaussians_backward_tensor_2d);
